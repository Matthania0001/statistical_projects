...
a._load_data()
a.remove_empty(["Profession_agreg_CM"])
b = a.df
...
# c = [liste_0, liste_1, liste_2, liste_3, liste_4, liste_5, liste_6, liste_7]
...
#         print(f"Nombre de valeurs: {len(w[i])}")
...
fig = px.box(
    ...
    color="Profession_agreg_CM",  # Couleurs par catégorie
    hover_data=["Profession_agreg_CM"]  # Infos supplémentaires au survol
)
